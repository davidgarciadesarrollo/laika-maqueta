...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>" rel="stylesheet"/>
   </head>
   <body class="bg-white">
       <!-- header -->
      ...
      <!-- Contenido -->
      <?php echo $__env->yieldContent('contenido'); ?> <?php $__env->startSection('contenido'); ?>
...
</html><?php /**PATH C:\laragon\www\laika-prueba\resources\views/layout/layout.blade.php ENDPATH**/ ?>